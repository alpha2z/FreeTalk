...
class RecentTableViewController: UITableViewController {
    ...
    var fromLogin:FromType?
    
    override func viewDidLoad() {
        super.viewDidLoad()
        println("on recent table")
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("RecentTableViewCell", forIndexPath: indexPath) as UITableViewCell
...
//        
//        println("unwindToBList exit......\(source.done)")
